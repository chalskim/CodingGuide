...
class LLMService:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.api_key = api_key or getattr(settings, "LLM_API_KEY", "***REMOVED***test")
        ...
        # 테스트 모드 설정 (API 키가 '***REMOVED***dummy' 또는 '***REMOVED***test'로 시작하면 테스트 모드 활성화)
        self.test_mode = self.api_key.startswith("***REMOVED***dummy") or self.api_key.startswith("***REMOVED***test")
