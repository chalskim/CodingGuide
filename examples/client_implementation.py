...
async def example():
    ...
    try:
        # 기본 클라이언트 초기화
        client = MCPClient('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', 'http://localhost:9000')
        ...
        custom_llm_config = CustomLLMConfig(
            ...
            api_key='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',
            temperature=0.8,
            max_tokens=500,
            options={
                'top_p': 0.95
